...
"use strict";document.addEventListener("DOMContentLoaded",(function(){document.getElementById("burger").addEventListener("click",(function(){document.querySelector(".header").classList.toggle("open")}))})),window.addEventListener("keydown",(function(e){"Escape"===e.key&&document.querySelector(".header").classList.remove("open")})),document.getElementById("menu").addEventListener("click",(function(e){e._isClickWithInMenu=!0})),document.getElementById("burger").addEventListener("click",(function(e){e._isClickWithInMenu=!0})),document.body.addEventListener("click",(function(e){e._isClickWithInMenu||document.querySelector(".header").classList.remove("open")}));var swiper=new Swiper(".swiper",{direction:"horizontal",loop:!0,speed:500,effect:"slider",slidesPerView:1,centeredSlides:!0,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0}});document.addEventListener("DOMContentLoaded",(function(){document.querySelector(".service__item__arrow_1").addEventListener("click",(function(){document.querySelector(".service__item_1").classList.toggle("open")}))})),document.addEventListener("DOMContentLoaded",(function(){document.querySelector(".service__item__arrow_2").addEventListener("click",(function(){document.querySelector(".service__item_2").classList.toggle("open")}))})),document.addEventListener("DOMContentLoaded",(function(){document.querySelector(".service__item__arrow_3").addEventListener("click",(function(){document.querySelector(".service__item_3").classList.toggle("open")}))})),document.addEventListener("DOMContentLoaded",(function(){document.querySelector(".service__item__arrow_4").addEventListener("click",(function(){document.querySelector(".service__item_4").classList.toggle("open")}))}));var swiper2=new Swiper(".swiper2",{direction:"horizontal",loop:!0,speed:500,effect:"slider",slidesPerView:1,centeredSlides:!0,spaceBetween:20,initialSlide:0,pagination:{el:".swiper-pagination",type:"fraction"},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{320:{pagination:{type:"bullets",clickable:!0}},768:{pagination:{type:"fraction"}}}});
